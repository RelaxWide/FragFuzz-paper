...
Setting $K=5$ therefore provides the minimum sufficient depth for TVDA's automated slicing to capture all core maintenance logic, without any hand-tuning per simulator.
