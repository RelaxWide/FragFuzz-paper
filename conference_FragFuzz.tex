...
To assess exploration of the maintenance datapath specifically, we manually curated the subset of basic blocks belonging to the I/O write/read and GC datapath; over this curated I/O-related subset, FragFuzz reaches approximately 99\% coverage, indicating near-complete exploration of the datapath logic that governs deep maintenance behavior.
