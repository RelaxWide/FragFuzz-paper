...
\begin{enumerate}
    ...
    \item \textbf{Comprehensive Evaluation:} On FEMU and MQSim, FragFuzz reaches deep maintenance logic with 65.0\% fewer commands than AFL++ while covering approximately 99\% of the manually curated I/O-related basic blocks, inducing not only GC triggers but also subsequent maintenance routines.
\end{enumerate}
